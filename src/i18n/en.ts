...
export const en: Record<keyof typeof it, string> = {
  ...
  opponentHelpTakebacks:
    'Every move taken back counts as a concession from Grandma, whether after her warning or by going back yourself. Replaying the same move does not count.',
  whyRethinkTitle: 'And where you changed your mind',
