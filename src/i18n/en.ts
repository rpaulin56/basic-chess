...
export const en: Record<keyof typeof it, string> = {
  ...
  rewindBefore: 'Game over. You are looking at the position before {move}.',
  ...
  askIntro_theory: 'You are still in the opening theory: I can show you with arrows the moves most often played from here.',
  askIntro_hint: 'I can tell you how many good moves there are here and, if you like, which ones.',
  askIntro_mate: 'Your opponent has only the King left: I can show you where to drive it and how to mate it.',
