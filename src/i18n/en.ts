...
export const en: Record<keyof typeof it, string> = {
  ...
  hint: 'Now what?',
  askReview: 'Where did it go wrong?',
  midTitle: 'Where it has gone wrong so far',
  midNothing: 'No real mistakes so far: the position got worse little by little.',
  midClose: 'Back to the game',
  storyReviews: 'you looked at the analysis {count} times',
  storyReviewsOne: 'you looked at the analysis during the game',
