...
export const en: Record<keyof typeof it, string> = {
  ...
  recapLine: '{number} {san} — {severity}: {what} ({state})',
  recapLinePending: '{number} {san} — {severity}: {what}',
  ...
  factLost: 'This leaves {what} hanging: {move}.',
  factMissed: 'There was {what} to take: {move}.',
  factWorse: 'Your position gets worse. Look at the consequences to see why.',
