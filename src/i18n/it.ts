export const it = {
  ...
  showBar: 'Barra della valutazione',
  statusOpponent: 'Nonna {n}, {attention}',
  ...
  whyForeign: 'Per analizzare questa partita ho bisogno di un po’ di tempo.',
  whyStop: 'Lascia perdere',
  whyTitle: 'Dove la partita è scivolata via',
  whyReviewResigned: 'Vuoi rivedere la partita?',
  whyTitleResigned: 'Una partita lasciata a metà',
  whyResignedWinning: 'Hai abbandonato quando stavi meglio tu: la partita era ancora tutta da giocare.',
  whyResignedBalanced: 'Hai abbandonato una posizione ancora in equilibrio.',
  whyResignedWorse: 'Stavi peggio, ma non era ancora persa.',
  whyTitleClean: 'Una bella partita',
  whyTitleWon: 'Qualche momento da rivedere',
  whyUnitsTitle: 'Che cosa sono i punti?',
  storyLoss: '{verdict} (-{drop} punti{note})',
  storyLostPiece: 'ci perdi {what}',
  ...
  storyStudied: 'hai studiato l’apertura',
  storyHintsOne: '1 consiglio',
  storyHints: '{count} consigli',
  ...
  playAsWhite: 'Con che colore giochi',
  playAsBlack: 'Con che colore giochi',
  colorWhite: 'Bianco',
  colorBlack: 'Nero',
  ...
  rewindFinished: 'Partita finita. Stai guardando la mossa {number} di {total}.',
  ...
  recap: 'La Nonna ha detto',
  helpTitle: 'Come ti aiuta la Nonna',
  stopsTitle: 'Quando ti ferma',
  stops_never: 'Mai',
  stops_blunders: 'Solo per gli errori gravi',
  stops_mistakes: 'Per gli errori',
  stops_inaccuracies: 'Anche per le imprecisioni',
  replayTitle: 'Quante volte ti lascia rigiocare',
  barOn: 'Sì',
  barOff: 'No',
  ...
  replayLeft: '{left} rimasti per la partita',
  replayLeftOne: '1 rimasto per la partita',
  ...
  replayLeftNone: 'Nessuno rimasto per la partita',
  stopsNoReplay: 'Senza rigiochi la Nonna non ti ferma: non potresti rifare la mossa.',
  stopsReplaysUsed: 'Non ti restano rigiochi: in questa partita la Nonna non ti ferma più.',
  ...
  hint: 'E adesso?',
  askHeading: 'Chiedi alla Nonna',
  askIntro_theory: 'Sei ancora in teoria: posso mostrarti con le frecce le mosse che si giocano di più da qui. Non conta come aiuto.',
  askIntro_hint: 'Posso dirti quante mosse buone ci sono qui e, se vuoi, quali. Conta come consiglio chiesto.',
  askIntro_mate: 'Al tuo avversario è rimasto solo il Re: posso mostrarti dove spingerlo e come dargli matto. Conta come consiglio chiesto.',
  askAccept_theory: 'Mostrami la teoria',
  askAccept_hint: 'Dammi un consiglio',
  askAccept_mate: 'Mostrami il piano',
  ...
  drawHeading: 'Patta?',
  drawProposalAccept: 'Accetto la patta',
  drawProposalDecline: 'Continuo a giocare',
  drawReason_knights: 'Con due Cavalli non si può forzare il matto: ti propongo la patta.',
  drawReason_minor: 'Con un solo pezzo leggero per parte e senza pedoni nessuno dei due può vincere: ti propongo la patta.',
  drawReason_rook: 'Torre contro Torre senza pedoni è patta: ti propongo la patta.',
  drawReason_queen: 'Donna contro Donna senza pedoni è quasi sempre patta: ti propongo la patta.',
  drawReason_flat: 'Da parecchie mosse nessuno dei due riesce a fare progressi: ti propongo la patta.',
  storyDrawProposed: 'qui ti ho proposto la patta',
