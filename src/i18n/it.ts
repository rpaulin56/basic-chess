export const it = {
  ...
  factLost: 'Così lasci {what} in presa: {move}.',
  factMissed: 'C’era {what} da prendere: {move}.',
  factWorse: 'La tua posizione peggiora. Guarda le conseguenze per capire perché.',
