export const it = {
  ...
  opponentHelpTakebacks:
    'Ogni mossa ripresa conta come una concessione della Nonna, dopo un suo avviso come tornando indietro a mano. Rigiocare la stessa mossa non conta.',
  whyRethinkTitle: 'E dove hai cambiato idea',
  ...
  whyRethinkTime: 'ci avevi pensato {time}',
  whyRethinkHasty: 'meno della metà della tua media',
