export const it = {
  ...
  language: 'Lingua',
  levelTitle: 'Quanto gioca forte la nonna (Elo)',
  playAs: 'Giochi con',
  ...
  posKingOpenFile: 'Si apre una colonna verso il tuo Re, dove l’avversario ha già un pezzo pesante.',
  ...
  posDoubled: 'Impedonati, i tuoi Pedoni diventano più difficili da difendere e far avanzare.',
  ...
  distractionTitle: 'Quanto è concentrata la nonna',
  distractionCareful: 'attenta',
  distractionSloppy: 'distratta',
  tutorMissedChance: 'Ho appena sbagliato io, e non te ne sei accorto.',
  ...
  opponentHelp: 'Che avversaria vuoi',
  opponentHelpTitle: 'Come scegliere l’avversaria',
  ...
  opponentHelpCareful: 'ATTENTA non regala niente: sbaglia solo per non aver visto abbastanza.',
  opponentHelpSloppy: 'DISTRATTA ogni tanto lascia un pezzo in presa. Ti allena a cogliere l’errore dell’altro, ma ti abitua anche ad aspettarlo.',
  opponentHelpElo: 'L’Elo accanto al livello è misurato, non dichiarato: cento partite contro un avversario di forza nota. Vale come ordine di grandezza, non al punto.',
  resign: 'Abbandona',
