export const it = {
  ...
  catStrategicoText: 'Non perdi materiale, ma la posizione peggiora irrimediabilmente.',
  pieceP: 'il pedone',
  ...
  orientNothing: 'Non spicca nessuna caratteristica particolare. Domandati questo: quale mio pezzo sta partecipando di meno, e come posso farlo giocare?',
  hintMore: '… e altre.',
