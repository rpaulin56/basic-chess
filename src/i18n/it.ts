export const it = {
  ...
  catBanale: 'Errore banale',
  catTattico: 'Errore tattico',
  catStrategico: 'Errore strategico',
  catBanaleText: 'Il pezzo viene catturato subito: perdi {loss}.',
  catTatticoText: 'La perdita non è immediata: arriva {moves} mosse più avanti, e costa {loss}.',
  catStrategicoText: 'Non perdi materiale, ma la posizione peggiora in modo stabile.',
  lossPawn: 'un pedone',
  lossPawns: '{count} pedoni di materiale',
