export const it = {
  ...
  storyMissedPiece: 'ti lasci scappare {what}',
  ...
  rewindBefore: 'Partita finita. Stai guardando la posizione prima di {move}.',
  ...
  askIntro_theory: 'Sei ancora in teoria: posso mostrarti con le frecce le mosse che si giocano di più da qui.',
  askIntro_hint: 'Posso dirti quante mosse buone ci sono qui e, se vuoi, quali.',
  askIntro_mate: 'Al tuo avversario è rimasto solo il Re: posso mostrarti dove spingerlo e come dargli matto.',
