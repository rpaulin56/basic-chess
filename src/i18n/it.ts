export const it = {
  ...
  hint: 'E adesso?',
  askReview: 'Dove è andata storta?',
  midTitle: 'Dove è andata storta finora',
  midNothing: 'Fin qui non hai fatto errori veri: la posizione è peggiorata poco per volta.',
  midClose: 'Torna alla partita',
  storyReviews: '{count} volte hai guardato l’analisi',
  storyReviewsOne: 'hai guardato l’analisi a metà partita',
